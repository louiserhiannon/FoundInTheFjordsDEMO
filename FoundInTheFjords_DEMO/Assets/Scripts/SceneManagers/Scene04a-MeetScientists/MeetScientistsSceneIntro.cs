...
public class MeetScientistsSceneIntro : MonoBehaviour
{
    ...
    public IEnumerator Scene04aIntro()
    {
        ...
        //orcaMom.GetComponentInChildren<JellyInteractions>().firstSelectionUI = false;
        //orcaMom.GetComponentInChildren<JellyInteractions>().firstSelectionAudio = false;
